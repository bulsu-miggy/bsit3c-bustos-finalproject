               ...
               <div class="container-fluid">
                  <div class="row mb-2">
                     <div class="col-sm-6 animated bounceInRight">
                        <h1 class="m-0"><span class="fas fa-book"></span> Issue Book</h1>
                     </div>
                     <!-- /.col -->
                     <div class="col-sm-6">
            ...
            <section class="content">
              ...
              <form role="form" method="post">
                <div class="card-body">
                  ...
                  <button type="submit" style="margin-left: 87%; margin-top: 5px;" class="btn btn-primary" name="issue" id="submit">Borrow Book</button>
                  <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="bookid" id="bookid" onBlur="getbook()"  required="required" />
...
$sql="INSERT INTO  Libraryv2.record(RollNo,BookId,Time) VALUES(:RollNo,:bookid,curtime())";
$query = $dbh->prepare($sql);
$query->bindParam(':RollNo',$rollno,PDO::PARAM_STR);
$query->bindParam(':bookid',$bookid,PDO::PARAM_STR);
$query->execute();
	echo "<script type='text/javascript'>alert('Success.')</script>";
   echo "<script>window.location.href='issue_requests.php'</script>";
}
