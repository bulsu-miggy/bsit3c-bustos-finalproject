      ...
      <div class="card shadow-lg">
        <div class="card-body text-center">
          <?php
            ...
            $image = $row['image'];
          ?>
          <img src="<?php echo $image ?>" alt="Profile" class="rounded-circle mb-3" width="200">
          <h2 class="mb-0"><?php echo $name ?></h2>
          <p class="text-muted mb-3"><?php echo $email ?></p>
          <p class="text-muted mb-3"><?php echo $mobno ?></p>
          <div class="d-grid gap-2">
            <a href="edit_admin_details.php" class="btn btn-primary">Edit Details</a>
            <a href="addadmin.php" class="btn btn-danger">Add admin</a>
          </div>
        </div>
      </div>
    </div>
