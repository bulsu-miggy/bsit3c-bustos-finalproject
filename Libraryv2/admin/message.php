               ...
               <div class="container-fluid">
                  <div class="row mb-2">
                     <div class="col-sm-6 animated bounceInRight">
                        <h1 class="m-0"><span class="fas fa-envelope"></span> Send Message</h1>
                     </div>
                     <!-- /.col -->
                     <div class="col-sm-6">
            ...
            <section class="content">
              ...
              <form action="message.php" method="post">
                <div class="card-body">
                  ...
                  <div class="col-md-12">
                     <div class="card-header">
                        <span class="fa fa-book"> Message Information</span>
              </div>
                  <div class="row">
                  <div class="col-md-6">
                  <div class="form-group">
                    <label>Sender</label>
                    <input type="text" class="form-control" id="Sender" name="Sender" value="<?php $sql="select * from Libraryv2.user where RollNo='$rollno'";
                   $result=$conn->query($sql);
                   $row=$result->fetch_assoc();
                 
        
                   $rollno=$row['RollNo'];  echo $rollno ?>"readonly>
                  </div>
               </div>
                  <div class="col-md-6">
                  <div class="form-group">
                    <label>Receiver Info</label>
                    <input type="text" class="form-control" placeholder="Username" id="RollNo" name="RollNo">
                  </div>
               </div>
               <div class="col-md-6">
                  <div class="form-group">
                    <label>Your Message</label>
                    <textarea class="form-control" placeholder="Enter content of your message here." id="Message" name="Message"></textarea>
                  </div>
               </div>
            </div>
              </div>
...
$sql1="insert into Libraryv2.message (RollNo,Sender,Msg,Date,Time) values ('$rollno','$Sender','$message',curdate(),curtime())";
