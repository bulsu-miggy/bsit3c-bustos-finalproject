   ...
   <body class="hold-transition sidebar-mini layout-fixed">
      <div class="wrapper">
         ...
         <div class="content-wrapper">
            ...
            <!-- /.content-header -->
            <!-- Main content -->
            <a class="btn btn-sm btn-success animated bounceInLeft" style="margin-left:35px" href="add_issue.php">Admin Request</a></li>
               ...
               <div class="container-fluid">
                  <div class="card-body animated pulse">
                     <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                        <?php
      $sql="select * from Libraryv2.record,Libraryv2.book where Date_of_Issue is NULL and record.BookId=book.BookId order by Time";
      $result=$conn->query($sql);
      ...
      ?>
                           <tr>
                              ...
                              <?php
                              if($avail > 0)
                              {echo "<a href=\"accept.php?id1=".$bookid."&id2=".$rollno."\" class=\"btn btn-sm btn-success\"><i
                                    class=\"fa fa-check\">Accept</i></a>";} ?>
                                <a type="submit" class="btn btn-sm btn-danger" href="reject.php?id1=<?php echo $id ?>&id2=<?php echo $rollno ?>" name="delete"><i
                                    class="fa fa-times">Reject</i></a>
                              </td>
                           </tr>
                           <?php } ?>
                            </tfoot>
